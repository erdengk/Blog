...
<body>
  <div class="header">
    ...
    <p class="welcome-text">
		<a href="login/user/login.html">登录</href>&nbsp&nbsp&nbsp&nbsp<a href="login/user/reg.html">注册</href>
		<a href="/githup/servlet/showAll">测试</href>
    </p>
  </div>
  ...
  <div class="content">
    <div class="cont w1000">
      ...
      <div id="demo" style="text-align: center;">123</div>
    </div>
  </div>
  ...
  <div class="footer-wrap">
    <div class="footer w1000">
      <div class="qrcode">
        <img src="html/res/img/erweima.jpg">
      </div>
      <div class="practice-mode">
        <img src="html/res/img/down_img.jpg">
        <div class="text">
