...
<body>
  <div class="header">
    ...
    <p class="welcome-text">
		<a href="user/login.html">登录</href>&nbsp&nbsp&nbsp&nbsp<a href="user/reg.html">注册</href>
		<a href="/githup/servlet/showAll">测试</href><a href="/githup/servlet/showBlog">home1</href>
		<a href="/githup/servlet/blog?number=2">blog测</href>
    </p>
  </div>
    ...
    <div class="cont w1000">
      <div class="title">
        <span class="layui-breadcrumb" lay-separator="|">
          <a href="javascript:;" class="active">热门博客</a>
		  <!--加载meta IE兼容文件
  ...
  <div class="footer-wrap">
    <div class="footer w1000">
      ...
      <div class="practice-mode">
        ...
        <div class="text">
          <h4 class="title">作者作品</h4>
          <p>githup<span class="WeChat">1234567890</span></p>
          <p>知乎<span class="iphone">1234567890</span></p>
          <p>邮箱<span class="email">1139957198@qq.com</span></p>
        </div>
      </div>
    </div>
  </div>
